...
const highlights = [
  { icon: Shield, text: 'SEC-compliant LLC-backed fractional ownership' },
  { icon: Globe, text: 'Invest in tokenized land, real estate, and more' },
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <blockquote className="text-3xl font-light leading-relaxed max-w-md">
            &ldquo;Join the future of asset ownership.&rdquo;
          </blockquote>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Get started with your investor portal and connect your XRPL wallet.
            </p>
          </div>
